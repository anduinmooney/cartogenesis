...
*A world generated by Cartogenesis v0.11.0 from seed `atlas`. Regenerate it exactly with `node src/cli.ts generate --seed atlas`.*
...
- **Dominant power:** Taunabi (of 2 surviving realm(s))
...
> Kimuma forged the first blade in the fires of Vyei and gave it to the bold of Jaziki.
...
> Hragrknyvik planted the first tree in Skyndhrei and hides still among the deep woods.

Followed across 10 region(s).

### the Faith of Phiathphethaiel — Phiathphethaiel, god of the Harvest

> Phiathphethaiel scattered the first seed across Sialthae; the golden fields were the gift, and the tithe the price.

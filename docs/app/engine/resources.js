...
const MOUNTAIN = new Set        ([Biome.Alpine, Biome.Snow]);
...
const GRASS = new Set        ([Biome.Grassland, Biome.Savanna, Biome.Shrubland]);
const COLD = new Set        ([Biome.Taiga, Biome.Tundra]);

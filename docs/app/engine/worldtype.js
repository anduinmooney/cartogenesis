...
function centre(rng     , cx        , cy        , r        , k        , strength = 1)             {
  return {
...
export function pickWorldType(rng     )            {
 ...
 */
export function maskAt(nx        , ny        , wt           )         {
  let m = 0;
...
export function edgeFalloff(nx        , ny        )         {

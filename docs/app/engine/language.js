 ...
 */
export function joinRoots(a        , b        , linker        )         {
  if (!a) return b;
  if (!b) return a;
...
function coinRoot(lang          , rng     , taken             )         {
 ...
 */
export function lexiconOf(lang          )          {
...
export function glossPhrase(gloss        )         {
 ...
 */
export function hintsForBiome(biome        )           {
  switch (biome) {

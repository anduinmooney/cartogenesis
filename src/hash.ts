 ...
 */
export function hashExact(data: Float64Array): string {
 ...
 */
export function hashTokens(tokens: ReadonlyArray<string | number>): string {
  let h1 = 0x2545f491 | 0;
  let h2 = 0x9e3779b9 | 0;
  const s = tokens.join("");
...
export function hashQuantized(data: ArrayLike<number>): string {
  let h1 = 0x9e3779b1 | 0;
  let h2 = 0x85ebca77 | 0;

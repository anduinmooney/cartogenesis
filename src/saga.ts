...
import { glossPhrase, lexiconOf } from "./language.ts";
...
export interface Saga {
  /** Culture this saga belongs to (language id: auld/meridian/kesh/sylvan). */
  cultureId: string;
  cultureLabel: string;
  title: string;
  /** Verse lines, ready to set as a block quote. */
  lines: string[];
}
...
export function generateSagas(
  ...
  const areaByCulture = new Map<string, number>();
